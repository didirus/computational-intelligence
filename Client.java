...
public class Client {
	...
	public static boolean runClient(String[] args, ParametersContainerE6 para) {
		...
		//System.out.println("Passed hurdle");
	...
	private static void parseParameters(String[] args) {
		...
		for (int i = 1; i < args.length; i++) {
			...
			if (entity.equals("blockerlevel")) {
				...
				//System.out.println("I am in level");
			...
			if (entity.equals("host")) {
				host = value;
				//System.out.println("I am in host");

			}
			if (entity.equals("id")) {
				clientId = value;
				//System.out.println("I am in id");
			}
			...
			if (entity.equals("trackName")) {
				trackName = value;
				//System.out.println("I am in trackName");
			}
			if (entity.equals("maxEpisodes")) {
				maxEpisodes = Integer.parseInt(value);
				//System.out.println("I am in maxEpisodes");
				if (maxEpisodes <= 0) {
					System.out.println(entity + ":" + value
							+ " is not a valid option");
					System.exit(0);
			...
			if (entity.equals("maxSteps")) {
				...
				//System.out.println("I am in maxSteps");
				if (maxSteps < 0) {
					System.out.println(entity + ":" + value
							+ " is not a valid option");
					System.exit(0);
